...
def main():
    ...
    for rep_i in range(args.num_repetitions):
        ...
        print(f'data rep: {model.data_rep}')
        ...
        print(f'sample shape after rot2xyz: {sample.shape}')
    ...
    print("all motions: ", [m.shape for m in all_motions])
    print(f'total_num_samples: {total_num_samples}')
    ...
    print(f'args.num_repetitions: {args.num_repetitions}')
    for sample_i in range(args.num_samples):
        ...
        for rep_i in range(args.num_repetitions):
            ...
            print('format: ', sample_print_template.format(caption, sample_i, rep_i, save_file))
            print(f'save_file: {type(save_file)}')
...
def save_multiple_samples(args, out_path, row_print_template, all_print_template, row_file_template, all_file_template,
    ...
    # print('all rep save path: ', all_rep_save_path)
    # print('ffmpeg_rep_cmd: ', ffmpeg_rep_cmd)
    os.system(ffmpeg_rep_cmd)
    print('f1', row_print_template.format(caption, sample_i, all_rep_save_file))
    ...
    if (sample_i + 1) % num_samples_in_out_file == 0 or sample_i + 1 == args.num_samples:
        ...
        print('f2', all_print_template.format(sample_i - len(sample_files) + 1, sample_i, all_sample_save_file))
